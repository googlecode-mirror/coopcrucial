        ...
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <div id="left">
                    ...
                    <h1 class="dashboard">Registros: Listado de registros</h1>
                    <p></p>
                    ...
                    <div class="div_content">
                        <table id="mytable" class="admin_table">
                            ...
                            <tbody class="ui-sortable">
                                <?php $dato->obtenerListadoRegistros(); ?>
                            </tbody>
                        </table>
                        <p>
                ...
                <div id="sidebar">
                    ...
                    <div class="sidebar_content">
                        <ul>
<!--                            <li><a href="registrosCrear.php">Nuevo Registro </a></li>-->
                            <li><a href="javascript:void(0);">Nuevo Registro </a></li>
