...
<div >
        ...
        <div class="BotonAgregar">Agregar al carrito</div>
        <input type="button" onclick="agregarCarrito({#$r.idProducto#},1);" value="Agregar al carrito" {#if $smarty.session.usuario.nombre==""#}disabled{#/if#}/>
    </div>
</div>
{#/foreach#}
