...
<div class="grid_8" style="background-color:#093;" >
    ...
    <div style="position:absolute; left: 260px;">
    	<div id="ContenedorCarroCompras" class="grid_4" align="right" style="height: 74px;">
    <div style="border: 1px solid #000; width: 58%; height: 72px; float: left;">
        {#if $smarty.session.usuario.nombre!=""#}
        <label>({#$carrito.cantidad#})</label> |
        {#/if#}
        <a href="javascript:void(0);" onclick="divCarrito();">Ir al Carro de Compras</a>
    </div>
    <div id="divCarrito" style="position: absolute; top: 30px; width: auto; background-color: #fff; border: 1px solid #000; z-index: 5; display: none;">
        <table>
            {#if $smarty.session.usuario.nombre!=""#}
    ...
    <div style="border: 1px solid #000; border-left: none; width: 40%; height: 72px; float: left;">
...
<div id="divUsos" class="grid_12" style="display: none; float: left;"></div>
<div id="divCategorias" class="grid_12" style="display: none; float: left;"></div>
